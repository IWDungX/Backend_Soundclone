...
registerRouter.post('/', async (req, res) => {
  try {
    ...
    if (existingUser) {
      // Nếu tài khoản có Google UID nhưng chưa có mật khẩu, cho phép người dùng đặt mật khẩu mới
      ...
      // Nếu tài khoản đã có cả Google UID và mật khẩu, báo lỗi
      ...
      // Nếu tài khoản có mật khẩu nhưng không có Google UID và người dùng đang cố gắng đăng nhập bằng Google
